 ...
 */
public class FZSharedPreferencesHelper {
    private final String TAG = FZSharedPreferencesHelper.class.getSimpleName();
    ...
    private FZSharedPreferencesHelper() {
    }

    private static class SharedPreferencesHelperHolder {
        private static FZSharedPreferencesHelper appSharedPreferencesHelper = new FZSharedPreferencesHelper();
    }

    public static FZSharedPreferencesHelper getInstance() {
    ...
    private String setupFolderPath(String imageName) {
        ...
        if (!mFolder.exists()) {
            if (!mFolder.mkdirs()) {
                FZLogUtils.e(TAG, "Default Save Path Creation Error");
            }
        }
