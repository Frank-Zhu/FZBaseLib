 ...
 */
public abstract class FZBaseAbstractRecycleCursorAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> implements Filterable,
     ...
     */
    public FZBaseAbstractRecycleCursorAdapter(Context context, Cursor c, int flags) {
